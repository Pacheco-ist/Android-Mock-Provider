package com.example.ricardo.mockprovidertest.TCP;
...
public class TCPClient {
     ...
     */
    public TCPClient(Handler mHandler, String command, String ipNumber, MessageCallback listener , int portnb, String map_name, FileTempStorage fileStorage) {
