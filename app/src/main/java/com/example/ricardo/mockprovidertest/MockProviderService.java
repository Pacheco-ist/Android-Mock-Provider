...
import com.example.ricardo.mockprovidertest.BLE.BluetoothLeService;
import com.example.ricardo.mockprovidertest.BLE.LeDeviceListAdapter;
import com.example.ricardo.mockprovidertest.BLE.SampleGattAttributes;
import com.example.ricardo.mockprovidertest.BLE.serverList;
import com.example.ricardo.mockprovidertest.TCP.FileTempStorage;
import com.example.ricardo.mockprovidertest.TCP.TCPClient;
...
public class MockProviderService  extends IntentService {
  ...
  public static final String TAG = "GpsMockProvider";
    ...
    void SendLocation(){
        ...
        for (int i =0 ; i < mLeDeviceListAdapter.getCount(); i++){
            Log.i(TAG, "Found: " + mLeDeviceListAdapter.getDevice(i).getAddress());
        }

        // retrieve data from the current line of text
        Double latitude =  46.67757400;
        Double longitude = 7.630668000;
        Double altitude= 634.61;
        ...
        LocInfo.putString("device", mLeDeviceListAdapter.getDevice(0).getName() );
